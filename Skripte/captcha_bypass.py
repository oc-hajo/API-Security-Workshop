...
def GetCaptcha(base_url):
    try:
        ...
        # TODO: Use pytesseract to parse image
        captcha_value = "[TODO] this is wrong, how to get the value from an image?"
...
if __name__ == '__main__':
    if len(sys.argv) >= 2:
        ...
        print("Usage: python3 solution1.py http://127.0.0.1:1234/lab1.php")
        sys.exit(0)
